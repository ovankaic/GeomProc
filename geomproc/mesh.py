...
class mesh:
    ...
    def data_to_color_with_zero(self, data, invert=False, percent=0.01, minimum=1.0, maximum=-1.0):
        """Transform vertex data into vertex colors while ensuring that zero is mapped to the center of the color spectrum (green color)
    ...
    def sample(self, num_samples):
        ...
        Notes
        -----
        The method uses face areas to perform a random sampling of
        points over the mesh. A point is assigned the normal of the face
        from where it was sampled.
    ...
    def add_noise(self, scale):
        ...
        Notes
        -----
        Simple noise function. For each vertex coordinate in the mesh,
